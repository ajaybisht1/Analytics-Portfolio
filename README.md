...
- Column A to G are retrieving from database and column H to N are manually added which formulas (Vlookup, IF error, Today) and these columns are useful to create next few worksheets.
